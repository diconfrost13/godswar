...
bool CMaster::Init()
{
	...
	sbase::ConsoleSetup();
	sbase::SetConsoleTitle("GodsWar PipeRouter Server"); 
	...
	cout<<"               ★★★★★★★★★★★★★★★★★★★★★★★★★"<<endl;
	cout<<"               ★                                              ★"<<endl;
	cout<<"               ★            GodsWar PipeRouter Server         ★"<<endl;
	cout<<"               ★       Copyright (c) 2007,欢乐连线工作室      ★"<<endl;
	cout<<"               ★             All rights reserved.             ★"<<endl;
	cout<<"               ★                                              ★"<<endl;
	cout<<"               ★★★★★★★★★★★★★★★★★★★★★★★★★\n\n\n"<<endl;

	cout<<"★★★GodsWar PipeRouter Server Initialize...★★★"<<endl<<endl;
	...
	m_Service[SERVICE_PIPE]    =  new PipeService();
	...
	for ( int i=0; i<SERVICE_COUNT; i++ )
	{
		if ( !m_Service[i]->Init() )
		{	 
			printf("Init PipeRouter Server failed!!\n");
			return false;	  
		}
	}
	return true;
