...
CREATE TABLE `accounts_ban` (
  `id` int(4) unsigned zerofill NOT NULL COMMENT '账号ID',
  `bandate` datetime NOT NULL COMMENT '禁止日期',
  `unbandate` datetime NOT NULL COMMENT '解禁日期',
  `bannedby` varchar(50) COLLATE utf8_unicode_ci NOT NULL COMMENT 'GM账号',
  `banreason` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT '禁止原因',
  PRIMARY KEY (`id`)
...
CREATE TABLE `accounts_info` (
  `id` int(4) unsigned NOT NULL AUTO_INCREMENT COMMENT '玩家编号',
  `accounts` varchar(32) COLLATE utf8_unicode_ci NOT NULL COMMENT '玩家帐号',
  `password` char(32) COLLATE utf8_unicode_ci NOT NULL COMMENT '密码',
  `login_status` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '登陆状态',
  `last_login_time` datetime NOT NULL COMMENT '上次登陆时间',
  `last_logout_time` datetime NOT NULL COMMENT '次上离线时间',
  `last_login_IP` char(20) CHARACTER SET gb2312 NOT NULL COMMENT '上次登陆IP',
  `last_login_mac` varchar(50) CHARACTER SET gb2312 NOT NULL COMMENT '上次登录MAC地址',
  `total_online_time` bigint(8) unsigned NOT NULL COMMENT '总在线时长',
  `accounts_status` tinyint(1) unsigned NOT NULL COMMENT '帐号状态',
  PRIMARY KEY (`id`),
...
CREATE TABLE `gamearea_info` (
  ...
  `IsDraw` tinyint(1) DEFAULT '0' COMMENT '是否领取奖励',
  PRIMARY KEY (`GID`),
...
CREATE TABLE `ip_ban` (
  `ip` varchar(32) COLLATE utf8_unicode_ci NOT NULL COMMENT '被禁IP',
  `bandate` datetime NOT NULL COMMENT '被禁时间',
  `unbandate` datetime NOT NULL COMMENT '解禁时间',
  `bannedby` varchar(50) COLLATE utf8_unicode_ci NOT NULL COMMENT 'GM账号',
  `banreason` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT '禁止原因',
  PRIMARY KEY (`ip`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
